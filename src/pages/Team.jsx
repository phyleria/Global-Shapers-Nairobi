...
export default function TeamPage() {
  ...
  return (
    <div style={{ paddingTop: '5rem' }}>
      ...
      {/* Group photo */}
      <div style={{ background: 'var(--white)', padding: '4rem 0' }}>
        <div className="container">
      ...
      <div style={{ background: 'var(--white)', padding: 'clamp(3rem,6vw,5rem) 0' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6,1fr)', gap: '1rem' }} className="members-grid">
            {members.map((m, i) => (
              <div key={i} style={{ textAlign: 'center', padding: '1.25rem 0.5rem', borderRadius: 'var(--radius)', border: '1px solid var(--border)', background: 'var(--off-white)', transition: 'transform 0.2s, box-shadow 0.2s, background 0.2s' }}
              ...
              >
                ...
                <p style={{ fontSize: '0.78rem', fontWeight: 600, color: 'var(--text-dark)', lineHeight: 1.3 }}>{m}</p>
              </div>
            ))}
          </div>
        </div>
